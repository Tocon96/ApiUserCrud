...
namespace ApiUserCrud.Client.BusinessLogic.Commands.UserCommands
{
    public class AddUserCommand : CommandBase
    {
        ...
        public AddUserCommand(INavigationService navigationService, IModalNavigationService modalNavigationService, IUserService userService, UserViewModel viewModel) 
        {
        ...
        {
            await userService.AddUser(viewModel.FirstName, viewModel.LastName, viewModel.Email);
